...
function createEditor() {
  ...
  // Excutes the ford fulkerson algorithm and updates the graph
  function runford_click() {
     var result = ford(networkGraph.nodes(), networkGraph.links());
  ...
  // This function performs ford fulkerson algorithm, determines the maximum flow,
  ...
  function stepNetworkFlow_click() {
     ...
     var res = ford(networkGraph.nodes(), networkGraph.links()),
         finalFlow = res[0],
         log = res[1];
